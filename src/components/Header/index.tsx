...
const Header = (): JSX.Element => {
  ...
  const [
    ruleModalVisible,
    {
      setTrue: openRuleModal,
      setFalse: closeRuleModal
    }
  ] = useBoolean(false)
  ...
  return (
    <>
      ...
      {/* <RuleModal isOpen={ruleModalVisible} closeModalHandler={closeRuleModal} /> */}
    </>
  )
}
